...
(function () {
    ...
    function getTurndownService(options, plugins, rules) {
        ...
        for (const ruleName in rules) {
            turndownService.addRule(ruleName, additionalRules[ruleName]);
        }
    ...
    let zhihu2md = function () {
        let turndownService = getTurndownService(basicOptions, [turndownPluginGfm.gfm], ['all_math','figure']);
